function showTime() {
	...
	var startDate = new Date(2022, 01, 04, 00, 26);
	...
	if (seconds < 10)
		seconds = "0" + seconds;
	var currentTimeString = "亲爱的姐姐:<br>"
		+ "我们已经相恋:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----爱你的弟弟</c>";
